...
function LoginPage() {
    ...
    const submit = async (e)=>{
        ...
        setMsg("");
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].login(form);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveSession"])(res.token, res.user);
...
_s(LoginPage, "b6KHJKw4OqOW1YEdaWd6zm+CAcI=", false, function() {
    return [
