...
"[project]/Downloads/farmlink_plus_full_project/frontend/src/app/login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const submit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$farmlink_plus_full_project$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].login({
                email: form.email,
                password: form.password
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$farmlink_plus_full_project$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveSession"])(res.token, res.user);
...
//# sourceMappingURL=Downloads_farmlink_plus_full_project_frontend_src_35d1a4db._.js.map